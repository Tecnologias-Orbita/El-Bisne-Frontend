...
export const businessAdminService = {
  ...
  createProduct(id: string, draft: ProductDraft) { return apiClient<Product>(`/businesses/${id}/catalog/products`, auth("POST", { ...draft, category_id: draft.category_id || null, platform_category_id: draft.platform_category_id || null, description: nullable(draft.description), image_url: nullable(draft.image_url) })); },
